...
export interface RegistryInterface extends utils.Interface {
  functions: {
    ...
    "userBorrowRequest((uint256,uint256,address,address,address,(uint32,uint256,uint256)),uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "userBorrowRequest",
    values: [Registry.VaultRequestStruct, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    "Bridged(address,bytes32)": EventFragment;
...
export interface BridgedEventObject {
  sender: string;
  transferId: string;
}
export type BridgedEvent = TypedEvent<[string, string], BridgedEventObject>;

export type BridgedEventFilter = TypedEventFilter<BridgedEvent>;
...
export interface Registry extends BaseContract {
  ...
  functions: {
    ...
    userBorrowRequest(
      _borrowRequest: Registry.VaultRequestStruct,
  ...
  filters: {
    "Bridged(address,bytes32)"(
      sender?: null,
      transferId?: null
    ): BridgedEventFilter;
    Bridged(sender?: null, transferId?: null): BridgedEventFilter;
