...
export interface PoolBase {
  ...
  _exactTokenInForTokenOut: (poolPairData: PoolPairBase, amount: OldBigNumber, exact: boolean) => OldBigNumber;
  _tokenInForExactTokenOut: (poolPairData: PoolPairBase, amount: OldBigNumber, exact: boolean) => OldBigNumber;
  _spotPriceAfterSwapExactTokenInForTokenOut: (poolPairData: PoolPairBase, amount: OldBigNumber) => OldBigNumber;
  _spotPriceAfterSwapTokenInForExactTokenOut: (poolPairData: PoolPairBase, amount: OldBigNumber) => OldBigNumber;
